...
(transporte ?posIni ?posFinal ?posAct ?estado coste ?coste numOps ?numOps numPasos ?numPasos PATH $?camino)
(test (and (eq numPasos ?*prof*) (<> ?posAct ?posFinal)))
=>
(halt)
)
;------------------------------------------------------------------------------------
