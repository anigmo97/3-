...
+!perform_look_action 
    <- ?debug(Mode); if (Mode<=3) { 
        ...
        /*	
        Contiene la lista de objetos que ahora mismo ve el agente. La estructura de un
        objeto es [#,	TEAM,	TYPE,	ANGLE,	DISTANCE,	HEALTH,	POSITION].
        Ejemplo: [1,200,1,0.58,14.76,78,pos(214,0,219)], el objeto 1 es del equipo 200 (AXIS), 
        del tipo 1 (agente),
        Manual de Jason - JGOMAS 6
        con el ángulo 0,58, a una distancia de 14,76, que tiene una salud de 78 y su posición 
        es pos(214,0,219).
